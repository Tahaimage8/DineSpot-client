...
import { updateOwnerReservationStatus } from "@/lib/actions/reservations";
import type {
  Reservation,
  ReservationStatus,
...
const OwnerReservations = ({
  ...
  const changeStatus = (
    ...
    setActiveId(reservationId);

    startTransition(async () => {
      try {
        const result =
          await updateOwnerReservationStatus(
            reservationId,
            status,
          );
    ...
    <section className="space-y-6">
      <div>
        ...
        <p className="muted-text mt-2">
          Review and update reservations for
          your restaurant.
        </p>
      </div>
      ...
      {filteredReservations.length === 0 ? (
        <div className="surface-card flex min-h-72 flex-col items-center justify-center p-8 text-center">
          ...
          <p className="muted-text mt-2">
            Matching restaurant reservations
            will appear here.
          </p>
        </div>
      ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-5 flex flex-wrap gap-2 border-t border-[var(--border)] pt-5">
                    ...
                    {isWorking && (
                      <p className="muted-text self-center text-sm">
                        Updating...
                      </p>
                    )}
                  </div>
